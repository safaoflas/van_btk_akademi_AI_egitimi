# %%
yeniliste = [2,4,5,6,23,33,44,20,17,21,12,2001, 2000]
...
def bulma(**kwargs):
    if "safa" in kwargs:
        print("safa lisans öğrencisidir.")
    else:
        print("Safa lisans öğrencisi değildir.")
